...
Source notes add research interpretation and verification history to stable
Wheel source IDs. They do not replace bibliographic records or source texts.

Copy `source-note-template.md`, name the file `{source-id}.md`, and preserve the
exact source ID in front matter.
